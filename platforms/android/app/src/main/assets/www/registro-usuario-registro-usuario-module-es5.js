...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["registro-usuario-registro-usuario-module"], {
  ...
  function srcAppRegistroUsuarioRegistroUsuarioPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var RegistroUsuarioPage = /*#__PURE__*/function () {
      function RegistroUsuarioPage(navCtrl, utiles, servicioGeo, loading, formBuilder, activatedRoute, router, acceso, parametrosApp) {
        var _this = this;
        ...
        this.router = router;
        this.acceso = acceso;
        this.parametrosApp = parametrosApp; //para validar
        ...
        value: function ngOnInit() {
          ...
          this.activatedRoute.queryParams.subscribe(function (params) {
            if (params && params.usuario) {
              ...
              _this2.nombreMostrar = _this2.registro.Nombres + " " + _this2.registro.Apellidos;
              console.log(_this2.registro);
              ...
              while (1) {
                switch (_context4.prev = _context4.next) {
                  ...
                  case 2:
                    ...
                    console.log(entidadRegistro); //antes de guardar
                                ...
                                if (!this.utiles.isAppOnDevice()) {
                                  ...
                                  this.servicioGeo.postRegistroFamilia(entidadRegistro).subscribe(function (data) {
                                    ...
                                    if (localStorage.getItem('STATE_CLAVE_UNICA')) {
                                      ...
                                      _this6.descartarCU(entidadRegistro.Run, state, entidadRegistro.Run, entidadRegistro.Password);
                                    } else {
                                      //hay que mandarlo autentificado y con los datos del usuario aps
                                      //ver que hacemos aca
                                      if (_this6.estaEditando) {
                                        _this6.utiles.presentToast("Registro modificado con éxito", "bottom", 2000);
                                      }

                                      if (_this6.estaAgregandoFamilia) {
                                        //hacer la operacion para agregar al usuario a la familia
                                        console.log('ESTA AGREGANDO FAMILIA');
                                      } else {
                                        _this6.autentificarse(entidadRegistro.Run, entidadRegistro.Password);
                                      }
                                    }
                                  });
                                } else {
                              ...
                              case 0:
                                if (!this.utiles.isAppOnDevice()) {
                                  ...
                                  this.servicioGeo.postValidacionClaveUnica(run, state).subscribe(function (response) {
                                    ...
                                    if (_this8.estaAgregandoFamilia) {
                                      //guardar los datos en la familia
                                      console.log('ESTA AGREGANDO FAMILIA');
                                    } else {
                                      _this8.autentificarse(usuario, passord);
                                    }
                                  });
                                } else {
                                  //nativa
                                ...
                                if (!this.utiles.isAppOnDevice()) {
                                  ...
                                  this.servicioGeo.postValidarCorreo(correo).subscribe(function (response) {
                                    ...
                                    if (response && response.CodigoMensaje != 0) {
                                      _this10.utiles.presentToast(response.Mensaje, "middle", 3000);

                                      _this10.forma.controls.email.setValue('');
                                    }
                                  });
                                } else {
                                  //llamada nativa
                                  this.servicioGeo.postValidarCorreoNative(correo).then(function (response) {
                                    ...
                                    _this10.utiles.presentToast('Ocurrió un al procesar clave única', 'bottom', 4000);
                                  });
                                }
