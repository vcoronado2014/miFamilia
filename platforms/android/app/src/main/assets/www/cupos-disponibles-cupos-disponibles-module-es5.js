...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["cupos-disponibles-cupos-disponibles-module"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppCuposDisponiblesCuposDisponiblesPageHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppCuposDisponiblesCuposDisponiblesModuleTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CuposDisponiblesPageModule", function () {
      return CuposDisponiblesPageModule;
    });
    /* harmony import */
    ...
    var _cupos_disponibles_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./cupos-disponibles.page */
    "./src/app/cupos-disponibles/cupos-disponibles.page.ts");

    var CuposDisponiblesPageModule = function CuposDisponiblesPageModule() {
      _classCallCheck(this, CuposDisponiblesPageModule);
    };

    CuposDisponiblesPageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
  ...
  /***/
  function srcAppCuposDisponiblesCuposDisponiblesPageScss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_exports__["default"] = ".titulo-semanas {\n  font-size: 0.8em;\n}\n\n.badge-cita {\n  position: absolute;\n  top: 2px;\n  right: 1px;\n  border-radius: 100%;\n}\n\n.danger {\n  color: var(--ion-color-danger);\n}\n\n.danger-boton {\n  --background: var(--ion-color-danger);\n}\n\n.success-boton {\n  --background: var(--ion-color-success);\n}\n\n.label-fecha {\n  padding-top: 28px;\n}\n/*# sourceMappingURL=data:application/json;base64, */";
    /***/
  },
  ...
  /***/
  function srcAppCuposDisponiblesCuposDisponiblesPageTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    __webpack_require__.d(__webpack_exports__, "CuposDisponiblesPage", function () {
      return CuposDisponiblesPage;
    });
    /* harmony import */
    ...
    var _app_pipes_filter_pipe__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
    ...
    "./src/app/modal-operacion-cita/modal-operacion-cita.page.ts"); //pipe
    //modal


    var CuposDisponiblesPage = /*#__PURE__*/function () {
      function CuposDisponiblesPage(navCtrl, toast, modalCtrl, platform, loading, menu, utiles, acceso, cita) {
        _classCallCheck(this, CuposDisponiblesPage);
        ...
        this.tipoOperacion = 'disponibilidad'; //tipos de atencion
      ...
      _createClass(CuposDisponiblesPage, [{
        ...
        value: function procesarRespuestaTotal(data, loader) {
          ...
          if (data && data.Mensaje) {
            ...
            if (data.Mensaje.Codigo == 'correcto') {
              ...
              if (this.semana.semanas && this.semana.semanas.length > 0) {
                this.semana.semanas.forEach(function (sem) {
                  ...
                  if (_this3.citas && _this3.citas.length > 0) {
                    ...
                    _this3.citas.forEach(function (cupo) {
                      //cupos = 0;
              ...
              this.cuposAgrupadosSelected = this.semana.semanas[0].CuposAgrupados; //this.cuposAgrupadosSelected = this.filter(this.semana.semanas[0].CuposAgrupados);
              //filtramos
        ...
        value: function agruparCitasTodas(arrCupos) {
          ...
          cuposAgrupados = Object.entries(nuevoObjeto); //console.log(this.objetoCita);
        ...
        key: "filtrarSemana",
        value: function filtrarSemana(semana) {
          var _this5 = this;
          ...
          if (semana) {
            ...
            if (semana.Cupos > 0) {
              var contador = 0;
              semana.Cupos.forEach(function (cupo) {
                if (cupo.TipoAtencion == _this5.comboSeleccionado) {
                  contador++;
                }
              }); //total de horas por tipo atencion

              semana.total = contador; //ahora se deben reprocesar las citas

              if (semana.CuposAgrupados && semana.CuposAgrupados.length > 0) {
                semana.CuposAgrupados.forEach(function (cupo) {
                  if (cupo[1].HorasDisponibles && cupo[1].HorasDisponibles.length > 0) {
                    cupo[1].HorasDisponibles.forEach(function (element) {
                      if (element.TipoAtencion != _this5.comboSeleccionado) {
              ...
              this.semana.semanas.forEach(function (sem) {
                ...
                if (sem.Cupos && sem.Cupos.length > 0) {
                  sem.Cupos.forEach(function (cupo) {
                    if (cupo.TipoAtencion == _this7.comboSeleccionado) {
                      tot++;
                    }
                  });
                }
        ...
        value: function filter(cuposDisponibles) {
          ...
          if (cuposDisponibles && cuposDisponibles.length > 0) {
            cuposDisponibles.forEach(function (cupo) {
              if (cupo[1].HorasDisponibles && cupo[1].HorasDisponibles.length > 0) {
                arr = fi.transform(cupo[1].HorasDisponibles, _this9.comboSeleccionado);
              }
            });
          }
                  ...
                  case 3:
                    ...
                    modal.onDidDismiss().then(function (data) {
                      if (data.data && data.data.accion) {
                        ...
                        _this10.construyeSemanaBuscar(pag, null); //revisar esto NO FUNCIONA
                        //this.seleccionarCuposAgrupados(this.itemSelected);
    ...
    CuposDisponiblesPage.ctorParameters = function () {
      return [{
    ...
    CuposDisponiblesPage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
      selector: 'app-cupos-disponibles',
      template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! raw-loader!./cupos-disponibles.page.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/cupos-disponibles/cupos-disponibles.page.html"))["default"],
      styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
      /*! ./cupos-disponibles.page.scss */
      "./src/app/cupos-disponibles/cupos-disponibles.page.scss"))["default"]]
    })], CuposDisponiblesPage);
    /***/
  }
}]);
//# sourceMappingURL=cupos-disponibles-cupos-disponibles-module-es5.js.map