      ...
      _createClass(BusquedaAvanzadaPage, [{
        ...
        value: function changeFechaInicio(event) {
          ...
          if (event.detail.value) {
            this.fechaInicioBusqueda = event.detail.value; //console.log(this.fechaInicioBusqueda);
          }
        }
      }, {
        key: "changeHorario",
        value: function changeHorario(event) {
          if (event.detail.value) {
            this.horarioBusqueda = event.detail.value; //console.log(this.horarioBusqueda);
          }
        }
      }, {
        key: "changeDia",
        value: function changeDia(event) {
          if (event.detail.value) {
            this.diasBusqueda = event.detail.value; //console.log(this.diasBusqueda);
          }
        }
      }]);
